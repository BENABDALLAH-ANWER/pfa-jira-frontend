...
var MotionValue = class {
  constructor(init) {
    ...
    this.updateAndNotify = (v, render = true) => {
      ...
      this.current = v;
      const { delta, timestamp } = getFrameData2();
      if (this.lastUpdated !== timestamp) {
        this.timeDelta = delta;
        this.lastUpdated = timestamp;
        es_default2.postRender(this.scheduleVelocityCheck);
      }
    ...
    this.scheduleVelocityCheck = () => es_default2.postRender(this.velocityCheck);
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    startAnimation(options) {
      ...
      this.pendingAnimation = es_default2.update(() => {
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react29.useCallback)(() => es_default2.postRender(forceRender), [forceRender]);
...
function useCombineMotionValues(values, combineValues) {
  ...
  updateValue();
  useMultiOnChange(values, () => es_default2.update(updateValue, false, true), () => cancelSync2.update(updateValue));
  return value;
}
...
function useInstantTransition() {
  ...
  (0, import_react49.useEffect)(() => {
    es_default2.postRender(() => es_default2.postRender(() => instantAnimationState.current = false));
  }, [forcedRenderCount]);
  return (callback) => {
